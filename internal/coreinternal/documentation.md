...
| ------------ | ----- | ----------- | ------------ | ---------- | --------- |
| `internal.coreinternal.goldendataset.DontEmitV0NetworkConventions` | beta | When enabled, goldendataset no longer generates spans with deprecated semconv v1.12.0/1.20.0 attributes (net.host.ip, net.peer.ip, http.host, http.server_name, http.client_ip). | v0.147.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/45076) |
